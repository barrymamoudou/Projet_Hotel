                        ...
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            ...
                            <div class="tab-content py-3">
                                    ...
                                    <div class="col-xl-12 mx-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                <h5 class="mb-4">Modification Chambre(s)</h5>
                                                
                                                <form action="{{route('update.room',$editData->id)}}" method="post" enctype="multipart/form-data" class="row g-3">
                                                    @csrf    
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="input2" class="form-label">Nombre total d’adultes</label>
                                                        <input type="text" name="total_adult" class="form-control" id="input2" value="{{ $editData->total_adult }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="input1" class="form-label">Nombre total d’enfants</label>
                                                        <input type="text" name="total_child" class="form-control" id="input1" value="{{ $editData->total_child }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="input1" class="form-label"> Prix de la chambre </label>
                                                        <input type="text" name="price" class="form-control" id="input1" value="{{ $editData->price }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="input2" class="form-label">Taille de la chambre</label>
                                                        <input type="text" name="size" class="form-control" id="input2" value="{{ $editData->size }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="input1" class="form-label">Remise ( % )</label>
                                                        <input type="text" name="discount" class="form-control" id="input1" value="{{ $editData->discount }}">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label for="input1" class="form-label">Capacité de la chambre</label>
                                                        <input type="text" name="room_capacity" class="form-control" id="input1" value="{{ $editData->room_capacity }}">
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label for="input7" class="form-label">Affichage de la
                                                        chambre</label>
                                                        <select name="view" id="input7" class="form-select">
                                                        <option selected="">Choose...</option>
                                                        <option value="Sea View" {{ $editData->view == 'Sea View'?'selected':''}}>Vue sur la Mer</option>
                                                        <option value="Hill View" {{ $editData->view == 'Hill View'?'selected':''}}>Hill View </option>
                                                    </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="input7" class="form-label">Type de Lit</label>
                                                        <select name="bed_style" id="input7" class="form-select">
                                                            <option selected="">Choose...</option>
                                                            <option value="Queen Bed" {{ $editData->bed_style == 'Queen Bed'?'selected':''}}>Lit queen size</option>
                                                            <option value="Twin Bed" {{ $editData->bed_style == 'Twin Bed'?'selected':''}}>Lit simple ou lits jumeaux</option>
                                                            <option value="King Bed" {{ $editData->bed_style == 'King Bed'?'selected':''}}>Lit king size</option>
                                                        </select>
                                                    </div>
                                                    
                                                    <div class="col-md-12">
                                                        <label for="input11" class="form-label">Description complète</label>
                                                        <textarea class="form-control"  name="short_desc" rows="3">{!! $editData->short_desc !!}</textarea>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="input11" class="form-label">Description complète</label>
                                                        <textarea class="form-control" name="description" rows="3">{!!  $editData->description !!}</textarea>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                           <a class="card-title float-rigth  btn btn-primary">
                                                <i class="lni lni-plus" onclick="addRoomNo()" id="addRoomNo">Add New</i>
                                           </a>
                                           <div class="roomnoHide" id="roomnoHide">
                                                <form action="" method="post" id>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button class=" btn btn-success" style="margin-top: 28px;">Save</button>
                                                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="" class="btn btn-danger px-3 radius-30">Danger</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                           </table>
