                                            ...
                                            <form action="{{route('update.room',$editData->id)}}"  method="post" enctype="multipart/form-data"  class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="input7" class="form-label">Affichage de la
                                                        chambre</label>
                                                    <select name="view" id="input7" selected class="form-select">
                                                        <option>Vue de la chambre....</option>
                                                        <option value="sea view">Vue sur la Mer</option>
                                                        <option value="Hill view">Vue sur la colline</option>
                                                    </select>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="input7" class="form-label">Type de Lit</label>
                                                    <select name="bed_style" id="input7" selected class="form-select">
                                                        <option value="queen bed">Lit queen size</option>
                                                        <option value="twin bed">Lit simple ou lits jumeaux</option>
                                                        <option value="king bed">Lit king size</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea id="myeditorinstance" name="description"
