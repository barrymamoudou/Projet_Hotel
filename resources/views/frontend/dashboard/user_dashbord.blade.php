                ...
                <div class="service-article">
                    ...
                    <div class="service-article-content">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 text-white card bg-primary" style="max-width: 18rem;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 text-white card bg-warning" style="max-width: 18rem;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 text-white card bg-success" style="max-width: 18rem;">
